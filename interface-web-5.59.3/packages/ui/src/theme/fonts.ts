...
// RapidDEX (§2 DESIGN_SYSTEM) — Geist is the display + body family on web.
// We keep Basel in the fallback chain so any cached font still resolves,
// and native (iOS/Android) continues to use Basel since we don't ship Geist
// font files to the mobile bundle.
const baselMedium = isWeb
  ? '"Geist", Basel, -apple-system, system-ui, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif'
