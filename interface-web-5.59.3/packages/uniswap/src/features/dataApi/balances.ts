...
import { fromGraphQLChain, hasGraphqlBackendChains } from 'uniswap/src/features/chains/utils'
...
export function usePortfolioBalances({
  ...
  const skipGraphqlQuery = !address || !hasGraphqlBackendChains(gqlChains)
