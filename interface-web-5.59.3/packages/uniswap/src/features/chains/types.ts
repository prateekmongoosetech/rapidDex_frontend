...
// MST DEX: only MST Testnet is supported
export const SUPPORTED_CHAIN_IDS: UniverseChainId[] = [UniverseChainId.MstTestnet]

export const SUPPORTED_TESTNET_CHAIN_IDS: UniverseChainId[] = [UniverseChainId.MstTestnet]

/** Deduped — MstTestnet appears in both supported + testnet lists for single-chain MST DEX. */
export const ALL_CHAIN_IDS: UniverseChainId[] = [...new Set([...SUPPORTED_CHAIN_IDS, ...SUPPORTED_TESTNET_CHAIN_IDS])]
