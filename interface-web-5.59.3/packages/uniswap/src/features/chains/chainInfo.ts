...
export const UNIVERSE_CHAIN_INFO: Record<UniverseChainId, UniverseChainInfo> = {
  [UniverseChainId.Mainnet]: {
    ...
    infoLink: 'https://mstblockchain.com',
  ...
  [UniverseChainId.ArbitrumOne]: {
    ...
    helpCenterUrl: 'https://mstblockchain.com/en/collections/3137787-uniswap-on-arbitrum',
    infoLink: 'https://mstblockchain.com/tokens/arbitrum',
  ...
  [UniverseChainId.Optimism]: {
    ...
    helpCenterUrl: 'https://mstblockchain.com/en/collections/3137778-uniswap-on-optimistic-ethereum-oξ',
    infoLink: 'https://mstblockchain.com/tokens/optimism',
  ...
  [UniverseChainId.Base]: {
    ...
    helpCenterUrl: undefined,
    infoLink: 'https://mstblockchain.com/tokens/base',
    interfaceName: 'base',
    label: 'Base',
    logo: BASE_LOGO,
    nativeCurrency: {
  ...
  [UniverseChainId.Bnb]: {
    ...
    infoLink: 'https://mstblockchain.com/tokens/bnb',
    ...
    rpcUrls: {
      ...
      [RPCType.Interface]: { http: [config.quicknodeBnbRpcUrl] },
    },
  ...
  [UniverseChainId.Polygon]: {
    ...
    helpCenterUrl: undefined,
    infoLink: 'https://mstblockchain.com/tokens/polygon',
  ...
  [UniverseChainId.Blast]: {
    ...
    helpCenterUrl: undefined,
    infoLink: 'https://mstblockchain.com/tokens/blast',
  ...
  [UniverseChainId.Avalanche]: {
    ...
    helpCenterUrl: undefined,
    infoLink: 'https://mstblockchain.com/tokens/avalanche',
  ...
  [UniverseChainId.Celo]: {
    ...
    helpCenterUrl: undefined,
    infoLink: 'https://mstblockchain.com/tokens/celo',
  ...
  [UniverseChainId.WorldChain]: {
    ...
    helpCenterUrl: undefined,
    infoLink: 'https://mstblockchain.com/tokens/ethereum/0x163f8c2467924be0ae7b5347228cabf260318753',
    infuraPrefix: undefined,
  ...
  [UniverseChainId.Zora]: {
    ...
    helpCenterUrl: undefined,
    infoLink: 'https://mstblockchain.com/tokens/zora',
    infuraPrefix: undefined,
    interfaceName: 'zora',
    label: 'Zora Network',
    logo: ZORA_LOGO,
    ...
    rpcUrls: {
      ...
      [RPCType.Interface]: { http: [config.quicknodeZoraRpcUrl] },
    },
  ...
  [UniverseChainId.Zksync]: {
    ...
    helpCenterUrl: undefined,
    infoLink: 'https://mstblockchain.com/tokens/zksync',
    infuraPrefix: undefined,
    ...
    rpcUrls: {
      ...
      [RPCType.Interface]: { http: [config.quicknodeZkSyncRpcUrl] },
    },
    urlParam: 'zksync',
    statusPage: undefined,
  ...
  [UniverseChainId.AstrochainSepolia]: {
    ...
    bridge: undefined,
    chainPriority: 0,
    docs: 'https://mstblockchain.com/', // need docs
    elementName: ElementName.ChainSepolia,
    explorer: {
    ...
    helpCenterUrl: undefined,
    infoLink: 'https://mstblockchain.com', // need
  ...
  [UniverseChainId.MstTestnet]: {
    name: 'MST Testnet',
    testnet: false,
    id: UniverseChainId.MstTestnet,
    sdkId: 91562037 as unknown as UniswapSDKChainId,
    assetRepoNetworkName: undefined,
    backendChain: {
      chain: 'mst_testnet' as unknown as GqlChainId,
      backendSupported: true,
      isSecondaryChain: false,
      nativeTokenBackendAddress: undefined,
    },
    ...
    chainPriority: 0,
    docs: 'https://mstblockchain.com/',
    elementName: ElementName.ChainMstTestnet,
    explorer: {
      name: 'MST Scan',
    ...
    spotPriceStablecoinAmount: CurrencyAmount.fromRawAmount(USDT_MST, 10_000e6),
    stablecoins: [USDT_MST],
    statusPage: undefined,
    supportsInterfaceClientSideRouting: true,
    supportsGasEstimates: true,
    urlParam: 'mst_testnet',
    wrappedNativeCurrency: {
      name: 'Wrapped MST',
      symbol: 'WMST',
      decimals: 18,
      address: '0x93199C4a0b7F5807E627E9A580b1ABF684Ae85E9',
    },
    nativeCurrencyLogo: ETHEREUM_LOGO,
    nativeCurrencyLogoDark: ETHEREUM_LOGO,
  } as unknown as UniverseChainInfo,
}
