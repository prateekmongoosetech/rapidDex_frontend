...
// MST Testnet tokens
export const USDT_MST = new Token(
  UniverseChainId.MstTestnet,
  '0xC07B0942F1fdD134192A2e0e258Cfc34A7ED1f03',
  6,
  'USDT',
  'Tether USD',
)

export const WBTC_MST = new Token(
  UniverseChainId.MstTestnet,
  '0x58EccaB223007d2d1bF546bf54b39bDF422bC068',
  8,
  'WBTC',
  'Wrapped BTC',
)

export const WMST = new Token(
  UniverseChainId.MstTestnet,
  '0x93199C4a0b7F5807E627E9A580b1ABF684Ae85E9',
  18,
  'WMST',
  'Wrapped MST',
)

class MstNativeCurrency extends NativeCurrency {
  ...
  constructor() {
    super(UniverseChainId.MstTestnet, 18, 'MST', 'MST')
  }
}

export const MST_NATIVE = new MstNativeCurrency()
...
export const WRAPPED_NATIVE_CURRENCY: { [chainId: number]: Token } = {
  ...
  [UniverseChainId.MstTestnet]: new Token(
    UniverseChainId.MstTestnet,
    '0x93199C4a0b7F5807E627E9A580b1ABF684Ae85E9',
    18,
    'WMST',
...
export function nativeOnChain(chainId: number): NativeCurrency | Token {
  ...
  if (chainId === UniverseChainId.MstTestnet) {
    nativeCurrency = MST_NATIVE
